...
![](attachments/Pasted image 20251214124339.png)

![](attachments/Pasted image 20251214124428.png)

![](attachments/Pasted image 20251214124446.png)
- On Server Roles : Check **Active Directory Domain Services**. 
![](attachments/Pasted image 20251214124606.png)
- Click Add Features.
![](attachments/Pasted image 20251214124512.png)
- Click Next all the way to Confirmation.
![](attachments/Pasted image 20251214124711.png)
- Install it an wait for the installation to finish.
![](attachments/Pasted image 20251214124743.png)
### Promote to Domain Controller
To promote the server to domain controller there is 2 option :
- Click it here after installation :
![](attachments/Pasted image 20251214124917.png)
- On the yellow triangle, at the top right flag icon. Click it
![](attachments/Pasted image 20251214125005.png)
- Select: **Add a new forest** , and write the root domain name `lab.local`
![](attachments/Pasted image 20251214125214.png)
...
![](attachments/Pasted image 20251214125611.png)
- Ignore the yellow warning
![](attachments/Pasted image 20251214125642.png)
- **Additional Options:** Verify NetBIOS name is `LAB`
![](attachments/Pasted image 20251214125719.png)
- **Paths:** Leave defaults.
![](attachments/Pasted image 20251214125816.png)
- **Prerequisites Check:** Wait for the green checkmark.
We got 2 problem , 1 which is critical :
- The Administrator password is blank 
![](attachments/Pasted image 20251214125938.png)
- So we set a password 
![](attachments/Pasted image 20251214130202.png)
- The click **Rerun Prerequisites Check**, and we get the green checkmark.
![](attachments/Pasted image 20251214130346.png)
- Click **Install** to begin installation.
![](attachments/Pasted image 20251214130432.png)
- The server will reboot automatically. 
## VERIFICATION
### Login & Verify
- When it comes back up, the login screen should say: `LAB\Administrator`.
![](attachments/Pasted image 20251214131943.png)
- Login.
...
![](attachments/Pasted image 20251214131530.png)
## Disclaimer 
For the 2 warning we got at the installation :
![](attachments/Pasted image 20251214130650.png)
